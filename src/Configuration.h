...
constexpr size_t StringLength1500 = 1500;				// Used when writing the resurrect info
...
#define RESTORE_DIR "0:/sys/restore/"					// Directory for backup purposes
...
#define PROCEDURES_DIR "procedures/"
#define USER_PROCEDURES_DIR "user_procedures/"
